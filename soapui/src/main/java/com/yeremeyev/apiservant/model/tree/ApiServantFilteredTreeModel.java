package com.yeremeyev.apiservant.model.tree;
...
public class ApiServantFilteredTreeModel extends SoapUITreeModel {
    private List<TreeFilter> filters = new ArrayList<>();
    boolean isFilterable = false;

    public ApiServantFilteredTreeModel(Workspace workspace) {
        super(workspace);
    }
