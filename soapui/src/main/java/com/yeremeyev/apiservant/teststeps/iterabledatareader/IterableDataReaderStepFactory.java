...
public class IterableDataReaderStepFactory extends WsdlTestStepFactory {
    ...
    public IterableDataReaderStepFactory() {
        super(ID_NAME, NAME, DESCRIPTION, ICON);
    }

    public WsdlTestStep buildTestStep(WsdlTestCase testCase, TestStepConfig config, boolean forLoadTest) {
        return new IterableDataReaderTestStep(testCase, config, forLoadTest);
    }
