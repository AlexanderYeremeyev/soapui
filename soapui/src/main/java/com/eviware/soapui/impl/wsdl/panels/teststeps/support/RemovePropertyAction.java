...
public class RemovePropertyAction extends AbstractAction {
    ...
    public RemovePropertyAction(JTable propertyTable, MutableTestPropertyHolder propertyHolder, String description, int nameColumnIndex) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String propertyName = propertyTable.getValueAt(row, nameColumnIndex).toString();
