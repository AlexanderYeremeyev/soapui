...
import com.eviware.soapui.impl.rest.panels.resource.RestParamsTableModelMode;
...
public class NewRestMethodAction extends AbstractSoapUIAction<RestResource> {
    ...
    public void perform(RestResource resource, Object param) {
        ...
        RestParamsTableModel paramsTableModel = new RestParamsTableModel(params, RestParamsTableModelMode.MEDIUM);
